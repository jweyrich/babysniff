...
typedef struct dns_hdr {
	...
	uint16_t	qd_c; // Number of entries in the question section
	uint16_t	an_c; // Number of resource records in the answer section
	uint16_t	ns_c; // Number of resource records in the authority section
	uint16_t	ar_c; // Number of resource records in the additional section
} dns_hdr_t;
